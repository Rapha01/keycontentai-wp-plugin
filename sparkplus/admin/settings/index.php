...
<div class="wrap sparkplus-settings-wrap">
    ...
    <div class="tab-content sparkplus-tab-content">
        ...
        switch ($active_tab) {
            case 'cpt':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-cpt.php';
                break;
            case 'general-context':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-general-context.php';
                break;
            case 'internal-linking':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-internal-linking.php';
                break;
            case 'api-settings':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-api-settings.php';
                break;
            case 'taxonomies':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-taxonomies.php';
                break;
            case 'seo':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-seo.php';
                break;
            case 'reset':
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-reset.php';
                break;
            default:
                $tab_file = SPARKPLUS_PLUGIN_DIR . 'sparkplus/admin/settings/tabs/tab-cpt.php';
                break;
