            ...
            <tbody>
                <tr>
                    <th scope="row">
                        <label for="sparkplus_openai_api_key">
                            <?php esc_html_e('OpenAI API Key', 'sparkplus'); ?>
                        </label>
                    </th>
                    <td>
                        <input 
                        ...
                        />
                        <p class="description">
                            <?php esc_html_e('Enter your OpenAI API key. You can get one from', 'sparkplus'); ?>
                            <a href="https://platform.openai.com/api-keys" target="_blank">
                                <?php esc_html_e('OpenAI Platform', 'sparkplus'); ?>
                            </a>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Select the GPT model to use for text content generation.', 'sparkplus'); ?>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Select the model to use for image generation.', 'sparkplus'); ?>
                        </p>
                    </td>
                </tr>
            </tbody>
